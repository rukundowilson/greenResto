import { DessertCategory } from "../types/index.js";
 ...
 */
export function sortProductsByPriceAsc(productsList) {
    return [...productsList].sort((a, b) => a.price - b.price);
}
/**
 * Sort products by price (descending)
 */
export function sortProductsByPriceDesc(productsList) {
    return [...productsList].sort((a, b) => b.price - a.price);
}
/**
 * Sort products by name (alphabetical)
 */
export function sortProductsByName(productsList) {
    return [...productsList].sort((a, b) => a.name.localeCompare(b.name));
}
/**
 * Filter products by price range
 */
export function filterProductsByPriceRange(productsList, minPrice, maxPrice) {
...
export function getCheapestProduct() {
    if (products.length === 0)
        return undefined;
    return products.reduce((cheapest, product) => product.price < cheapest.price ? product : cheapest);
}
/**
...
export function getMostExpensiveProduct() {
    if (products.length === 0)
        return undefined;
    return products.reduce((expensive, product) => product.price > expensive.price ? product : expensive);
}
